...
export default class DataSheet_localizationSheet extends DataSheetBase {
  ...
  makeDefaultItems() {
    ...
    item = {};
    this.items.push(item);
    item['key'] = "listitemweeksdetails2_text_1029876";
    item['en'] = " ";
    
    item = {};
    this.items.push(item);
    item['key'] = "listitemweeksdetails2_textcopy_535680";
    item['en'] = "Sep-12-2019";
    
    item = {};
    this.items.push(item);
    item['key'] = "listitemweeksdetails2_textcopy3_738252";
    item['en'] = "Week score";
    
    item = {};
    this.items.push(item);
    item['key'] = "listitemweeksdetails2_textcopy2_200187";
    item['en'] = "ID";
    
    item = {};
    this.items.push(item);
    item['key'] = "listitemweeksdetails2_button_660615";
    item['en'] = "Activities";
  }
