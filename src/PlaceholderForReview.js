      ...
      <div className="PlaceholderForReview" style={baseStyle}>
        ...
        <div className="layoutFlow">
          <div className='hasNestedComps elListItemReview'>
            <div>
              <ListItemReview ref={(el)=> this._elListItemReview = el} reviewSubject={this.props.reviewSubject || ""} reviewerName={this.props.reviewerName} reviewRating={this.props.reviewRating} reviewText={this.props.reviewText} reviewerProfilePicUrl={this.props.reviewerProfilePicUrl} reviewDate={this.props.reviewDate} {...this.props} visualStateIndex={transformStateValue_listItemReview(this.props.userID)} appActions={this.props.appActions} deviceInfo={this.props.deviceInfo} locStrings={this.props.locStrings} />
            </div>
